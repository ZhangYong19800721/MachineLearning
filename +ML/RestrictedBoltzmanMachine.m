classdef RestrictedBoltzmanMachine
    %RESTRICTEDBOLTZMANMACHINE 约束玻尔兹曼机
    %   
    ...
    methods
        function obj = RestrictedBoltzmanMachine(num_visual,num_hidden) % 构造函数
    ...
    methods
        function obj = construct(obj,weight,hidden_bias,visual_bias)
