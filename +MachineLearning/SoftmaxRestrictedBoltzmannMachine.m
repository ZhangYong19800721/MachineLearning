classdef SoftmaxRestrictedBoltzmannMachine
    %SoftmaxRestrictedBoltzmannMachine 带Softmax神经元的约束玻尔兹曼机
    %   
    ...
    methods
        function obj = SoftmaxRestrictedBoltzmannMachine(num_softmax,num_visual,num_hidden) % 构造函数
    ...
    methods (Access = private)
        function [d_weight,d_h_bias,d_v_bias,r_error] = CD1(obj, minibatch)
            ...
            d_v_bias = (minibatch - [s_field_1;v_field_1]) * ones(N,1) / N;
        end
