classdef QuadraticSSC
    ...
    methods(Access = public)
        function y = compare(obj,points1,points2)
            ...
            v1 = sum((points1' * obj.A) .* points1',2)' + obj.B * points1 + repmat(obj.C,1,N1);
            v2 = sum((points2' * obj.A) .* points2',2)' + obj.B * points2 + repmat(obj.C,1,N2);
            c1 = v1 > 0;
            c2 = v2 > 0;
            y = obj.a * (c1==c2) + obj.b;
        end
        ...
        function y = compute(obj,points,paridx)
            ...
            [~,N] = size(points); 
            v = sum((points' * obj.A) .* points',2)' + obj.B * points + repmat(obj.C,1,N);
